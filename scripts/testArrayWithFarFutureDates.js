...
async function testArrayWithFarFutureDates() {
  try {
    console.log('Testing Array Format with Far Future Dates...');
    ...
    const mockReq1 = {
      body: {
        availabilityDate: '2026-01-20' // Far future date as string
      },
      user: {
        id: labourUser._id
      }
    ...
    const mockReq2 = {
      body: {
        availabilityDate: ['2026-01-20'] // Far future date in array
      },
      user: {
        id: labourUser._id
      }
    ...
    const mockReq3 = {
      body: {
        availabilityDate: ['2026-01-21', '2026-01-22', '2026-01-23'] // Far future dates in array
      },
      user: {
        id: labourUser._id
      }
    ...
    console.log('\n✅ Array format testing with far future dates completed!');
    console.log('\n📋 Summary:');
